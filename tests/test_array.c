...
int main(void) {
	...
	scpArray.print(array, scpPrint_size_t);
	putc('\n', stdout);
	...
	struct scpArray* fclone = scpArray_fclone(array, scpCopy_size_t);
	...
	printf("clone:  ");
	scpArray.print(clone, scpPrint_size_t);
	putc('\n', stdout);

	printf("fclone: ");
	scpArray.print(fclone, scpPrint_size_t);
	putc('\n', stdout);
