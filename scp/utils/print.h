...
_SCP_MAKE_ALL_NEW_PRINT_INTEGER
...
void scpPrint_char(const void* data);
void scpPrint_wchar(const void* data);

void scpPrint_string(const void* data);
void scpPrint_wstring(const void* data);
...
#undef _SCP_MAKE_ALL_NEW_PRINT_INTEGER
